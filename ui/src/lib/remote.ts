...
class APIBridge {
    ...
    async set_current_book(book_uid:any) {
    ...
    async update_book_title(book_uid:any, new_title:string) {
        return this.boundary.remote('update_book_title', book_uid, new_title);
    }

    async fetch_book_simple(book_uid:any) {
    ...
    async fetch_chapter(chapter_id:any, stripped:boolean = false) {
    ...
    async fetch_scene_markedup(scene_uid:any) {
    ...
    async delete_scene(chapter_uid:any, scene_uid:any) {
