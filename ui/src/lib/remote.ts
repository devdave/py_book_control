...
class APIBridge {
    ...
    async reorder_chapter(book_uid:any, from_pos:any, to_pos:any) {
        return await this.boundary.remote('reorder_chapter', book_uid, from_pos, to_pos);
    }
    ...
    async remove_character_from_scene(character_uid:any, scene_uid:any) {
        return await this.boundary.remote('remove_character_from_scene', character_uid, scene_uid);
    }
    ...
    async bulkDefaultSettings(changeset:any) {
        return await this.boundary.remote('bulkDefaultSettings', changeset);
    }
